...
from coder.cli.console_terminal import MAIN_COLOR, ConsoleTerminal
from coder.core.project import Project
from coder.core.steps.steps import StepType

COMMAND_NAME = "J.A.R.V.I.S. Coder"
app = typer.Typer()
